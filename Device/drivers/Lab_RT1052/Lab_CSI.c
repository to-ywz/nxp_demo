...
/* 摄像头使用硬件资源 这里没有用到 */
static LabMT9V034_resource_t LabMT9V034Resource;

/* 摄像头驱动配置结构体 */
camera_device_handle_t cameraDevice = {          
    .resource = &LabMT9V034Resource,
    .ops = &LabMT9V034_ops,
};
...
/**
  ...
  * @date     2019/6/24 星期一
  */
void Lab_Camera_Init(void)  
{
#if (defined LabOV7725) && (defined LabOV7725YUV)
    cameraConfig.pixelFormat = kVIDEO_PixelFormatYUYV;
#endif
    Lab_IIC_Init(LPI2C1, 10000);
    Lab_CSI_Init();
...
#if  (defined LabMT9V034) || (defined LabOV7725RGB)   
