...
void Lab_ServoCtrl(uint8_t channel, uint16_t duty);
...
/**
  ...
  * @date     2019/5/23 星期四
  */
void Lab_SetMotorDty(uint8_t num, short duty);
...
/**
  ...
  * @date     2019/5/23 星期四
  */
void Lab_SetServoDty(uint16_t duty);
...
/**
  ...
  * @date     2019/5/23 星期四
  */
void Lab_PWMA_B_SetDuty(PWM_Type *base, pwm_submodule_t subModule, uint16_t dutyA, uint16_t dutyB);
...
/**
  ...
  * @date     2019/5/23 星期四
  */
void Lab_PWM_SetDuty(PWM_Type *base, pwm_submodule_t subModule, pwm_channels_t pwm_channels, uint16_t duty);
