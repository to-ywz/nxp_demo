...
void Test_9AX(void)
{
    ...
    TFTSPI_P8X16Str(2,0,"Lab 9AX Test",u16RED,u16BLUE);
...
void Test_9AX(void)
{
    ...
    LCD_P8x16Str(15,0,"Lab 9AX Test"); 
    PRINTF("\r\nLab 9AX Test\n");
...
/**
  ...
  *  2        截止频率   64      32      16       8      4     —       —
  *
  * @example  FX_21002_SetLP(0) //如果采样速率 800Hz 则低通滤波截止频率 256
  *
  * @date     2019/6/13 星期四
  */
