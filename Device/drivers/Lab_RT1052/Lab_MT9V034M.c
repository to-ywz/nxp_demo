 ...
 * Prototypes
 ******************************************************************************/
status_t LabMT9V034_Init(camera_device_handle_t *handle, const camera_config_t *config);
status_t LabMT9V034_InitExt(camera_device_handle_t *handle, const camera_config_t *config, const void *specialConfig);
status_t LabMT9V034_Deinit(camera_device_handle_t *handle);
status_t LabMT9V034_Control(camera_device_handle_t *handle, camera_device_cmd_t cmd, int32_t arg);
status_t LabMT9V034_Start(camera_device_handle_t *handle);
status_t LabMT9V034_Stop(camera_device_handle_t *handle);
/*******************************************************************************
 * Variables
 ******************************************************************************/
const camera_device_operations_t LabMT9V034_ops = {
    .init = LabMT9V034_Init,
    .deinit = LabMT9V034_Deinit,
    .start = LabMT9V034_Start,
    .stop = LabMT9V034_Stop,
    .control = LabMT9V034_Control,
    .init_ext = LabMT9V034_InitExt,
};
...
status_t LabMT9V034_Deinit(camera_device_handle_t *handle)
{
    ((LabMT9V034_resource_t *)(handle->resource))->pullPowerDownPin(true);
...
status_t LabMT9V034_InitExt(camera_device_handle_t *handle, const camera_config_t *config, const void *specialConfig)
{
    return LabMT9V034_Init(handle, config);
}
/*@@
  * @brief    帧率设置
  *
