...
/**
  ...
  * @date     2019/6/10 星期一
  */
void Lab_ADC_Init(ADC_Type *base, ADCn_Ch_e CH)
{    
    ADC_PinInit(base, CH);
...
void Test_ADC(void)
{
    ...
    LED_Init();
    KEY_Init();               
    Lab_ADC_Init(ADC1, ADC1_CH1);   
    Lab_ADC_Init(ADC1, ADC1_CH2); 
    Lab_ADC_Init(ADC1, ADC1_CH3); 
    Lab_ADC_Init(ADC1, ADC1_CH4); 
    Lab_ADC_Init(ADC1, ADC1_CH7); 
    Lab_ADC_Init(ADC1, ADC1_CH8); 
    Lab_ADC_Init(ADC1, ADC1_CH10); 
    
    Lab_UART_Init(LPUART8, 115200); 
    
    LCD_P8x16Str(4,0,"Lab ADC Test"); 
    UART_PutStr(LPUART8, "\r\nLab ADC Test");
    ...
    {           
        ...
        if(0 == key)
        {
            LCD_P8x16Str(4,0,"Lab ADC Test Bat"); 
...
void Test_ADC(void)
{
    ...
    Lab_UART_Init(LPUART8, 115200);
    TFTSPI_P8X16Str(2,0,"Lab ADC Test",u16RED,u16BLUE);
