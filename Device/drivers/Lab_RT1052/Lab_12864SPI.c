...
{      
    ...
    LED_Init();                          //LED初始化
    LCD_Init();                          //LCD初始化 
    LCD_Show_LabLogo();                   //显示LOGO
    delayms(1000);  
    LCD_CLS();                           //LCD清屏      
    LCD_P8x16Str(20,0,"Lab Test KEY");
    while (1)
    {  
        //测试按键      
        ...
        switch(KEY_Read(0))  //
        {
          case 1:
            LCD_CLS();  //清屏
            LCD_P6x8Str(13,3,"KEY0 Pressed!   ");
            LED_Color(red);     //红灯
            break;           
          case 2:       
            LCD_CLS();  //清屏
            LCD_P6x8Str(13,5,"KEY1 Pressed!   ");
            LED_Color(green);   //绿灯
            break;
          case 3:       
            LCD_CLS();  //清屏
            LCD_P6x8Str(13,7,"KEY2 Pressed!   ");
            LED_Color(blue);    //蓝灯
            break;
          default:
            LCD_P8x16Str(20,0,"Lab Test KEY");
