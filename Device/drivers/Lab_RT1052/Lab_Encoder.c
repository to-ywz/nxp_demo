...
/**
  ...
  * @date     2019/6/12 星期三
  */
void Lab_ENC_Init(ENC_Type *base, bool direction)
{
    ENC_PinInit(base);
...
{   
    ...
    LED_Init();
    Lab_ENC_Init(ENC1, true);   
    Lab_ENC_Init(ENC2, true);
    Lab_ENC_Init(ENC3, true);
    Lab_ENC_Init(ENC4, true);
    short velocity1, velocity2, velocity3, velocity4;
    char txt[16];
    TFTSPI_P8X16Str(2,0,"Lab ENC Test",u16RED,u16BLUE);
    PRINTF("\r\n编码器正交解码测试:\r\n");    
    while (1)
    { 
