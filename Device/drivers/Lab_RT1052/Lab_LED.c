...
void LED_Color(LED_t color)
{
    ...
    case cyan:
        ...
        break;
    case B_red:
        GPIO_PinWrite(GPIO2, 22, 0U); //LED亮;
        break;
    case B_blue:
        GPIO_PinWrite(GPIO2, 25, 0U); //LED亮;
        break;
    }
}
...
void LED_Color(LED_t color)
{
    ...
    {
    case white:
        Lab_PinWrite(B12, 0U); //LED亮;
        Lab_PinWrite(A7, 0U);  //LED亮;
        Lab_PinWrite(C7, 0U);  //LED亮;
        break;
    case black:
        Lab_PinWrite(B12, 1U); //LED灭;
        Lab_PinWrite(A7, 1U);  //LED灭;
        Lab_PinWrite(C7, 1U);  //LED灭;
        Lab_PinWrite(C12, 1U); //LED亮;
        Lab_PinWrite(A13, 1U); //LED亮;
        break;
    case red:
        Lab_PinWrite(B12, 1U); //LED灭;
        Lab_PinWrite(A7, 0U);  //LED亮;
    ...
    case cyan:
        ...
        break;
    case B_red:
        Lab_PinWrite(C12, 0U); //LED亮;
        break;
    case B_blue:
        Lab_PinWrite(A13, 0U); //LED亮;
        break;
    }
}
