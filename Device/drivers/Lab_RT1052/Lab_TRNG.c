...
void Test_RNG(void)
{
    ...
    LCD_Init();                  //LCD初始化
    LCD_CLS();                   //LCD清屏
    LCD_P8x16Str(4,0,"Lab TRNG Test"); 
    ...
    if (kStatus_Success == status)
    {
        while (1)
        {
            ...
            else
            {
                PRINTF("TRNG failed!\r\n");
                LCD_CLS();                //清屏
                LCD_P8x16Str(2,0,"Lab TRNG Test Fail");
            }            
...
void Test_RNG(void)
{
    ...
    TFTSPI_P8X16Str(2,0,"Lab TRNG Test",u16RED,u16BLUE);
    ...
    if (kStatus_Success == status)
    {
        while (1)
        {
            ...
            else
            {
                PRINTF("TRNG failed!\r\n");
                TFTSPI_CLS(u16BLUE);                //清屏
                TFTSPI_P8X16Str(2,0,"Lab TRNG Test Fail",u16RED,u16BLUE);
            }            
        LED_ColorReverse(blue);//蓝灯翻转
        delayms(1000);          //延时1秒
        }
